...
Find below the assignments. The assignment have to be submitted via Canvas at the end of this block.
...
{
  fl = paste0("data_science_assignment_", i, ".Rmd")
  cat(paste0("[Assignment ", i, "](assignments/", fl, ") ([download](rmd/", fl, ")) </br>"))
}
cat("</br>")
```
