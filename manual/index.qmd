...
visible_solutions = 2
visible_lectures = 2
visible_assignments = 1
visible_assignment_solutions = 0
...
# Assignments (Rmd files)

You can download the R-Markdown (.Rmd) files with the exercises for the assignments. You can open these files in RStudio and make changes.

```{r}
#| output: asis
#| echo: false
for (i in 1:visible_assignments)
{
  cat(paste0("[Assignment Rmd ", i, "](assignments/data_science_assignment_", i, ".Rmd)&nbsp;&nbsp;&nbsp;&nbsp;"))
}
cat("</br>")
```
...
#| output: asis
#| echo: false
if (visible_assignment_solutions == 0) {
  cat("*-- coming soon --*")
} else {
  for (i in 1:visible_solutions)
  {
    cat(paste0("[Solution Week ", i+2, "](practicals/data_science_week", i, "_assignment_solution.Rmd)&nbsp;&nbsp;&nbsp;&nbsp;"))
  }
}
cat("</br>")
```
