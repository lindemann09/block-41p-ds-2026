...
| Date        | Week | Room        | Practical   (11:00) | Lecture (13:00)         |
| ----------- | :---: | ----------- | ------------------- | ----------------------- |
| `r week(1)` |   1   | `r room(1)` | `r practical(1)`    | `r lecture(1)`  (OL,YM) |
| `r week(2)` |   2   | `r room(2)` | `r practical(2)`    | `r lecture(2)`  (YM)    |
| `r week(3)` |       |             | *NO MEETING*        | *NO MEETING*            |
| `r week(4)` |   3   | `r room(4)` | `r practical(3)`    | `r lecture(3)`  (OL)    |
| `r week(5)` |   4   | `r room(5)` | `r practical(4)`    | `r lecture(4)`  (YM)    |
| `r week(6)` |   5   | `r room(6)` | `r practical(5)`    | `r lecture(5)`  (YM)    |
| `r week(7)` |   6   | `r room(7)` | `r practical(6)`    | `r lecture(6)`  (OL)    |
| `r week(8)` |   7   | `r room(8)` | `r practical(7)`    | `r lecture(7)`  (YM,OL) |
...
{
  cat(paste0("[Practical Rmd Week ", i, "](rmd/data_science_week", i, ".Rmd)&nbsp;&nbsp;&nbsp;&nbsp;"))
}
cat("</br>")
```
...
The assignments are group assignments. Please form subgroups of two or three students. Every **group** has to do **one** assignment of their choice and submit it via Canvas at the **end of this block**. The assignments are not graded, but they are mandatory to pass the course.

* [Assignment 1: Parameter Estimation](assignments/data_science_assignment_1.Rmd) ([download](rmd/data_science_assignment_1.Rmd))
* Assignment 2: Neural Networks (will appear after the lecture on Neural Networks)
